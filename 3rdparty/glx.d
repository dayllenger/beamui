...
void loadGLXExtensions()
{
    ...
    if (hasExtension(extensions, "GLX_NV_video_capture"))
    {
        _GLX_NV_video_capture =
            ...
            bindGLXFunc(cast(void**)&glXReleaseVideoCaptureDeviceNV, "glXReleaseVideoCaptureDeviceNV");
    }
    ...
    if (hasExtension(extensions, "GLX_SGIX_fbconfig"))
    {
        _GLX_SGIX_fbconfig =
            ...
            bindGLXFunc(cast(void**)&glXGetFBConfigFromVisualSGIX, "glXGetFBConfigFromVisualSGIX");
    }
...
{
    bool GLX_ARB_create_context() { return _GLX_ARB_create_context; }
    bool GLX_ARB_get_proc_address() { return _GLX_ARB_get_proc_address; }
    bool GLX_EXT_import_context() { return _GLX_EXT_import_context; }
    bool GLX_EXT_swap_control() { return _GLX_EXT_swap_control; }
    bool GLX_EXT_texture_from_pixmap() { return _GLX_EXT_texture_from_pixmap; }
    bool GLX_MESA_agp_offset() { return _GLX_MESA_agp_offset; }
    bool GLX_MESA_swap_control() { return _GLX_MESA_swap_control; }
    bool GLX_MESA_pixmap_colormap() { return _GLX_MESA_pixmap_colormap; }
    bool GLX_MESA_release_buffers() { return _GLX_MESA_release_buffers; }
    bool GLX_MESA_set_3dfx_mode() { return _GLX_MESA_set_3dfx_mode; }
    bool GLX_NV_copy_image() { return _GLX_NV_copy_image; }
    bool GLX_NV_present_video() { return _GLX_NV_present_video; }
    bool GLX_NV_swap_group() { return _GLX_NV_swap_group; }
    bool GLX_NV_video_capture() { return _GLX_NV_video_capture; }
    bool GLX_NV_video_output() { return _GLX_NV_video_output; }
    bool GLX_OML_sync_control() { return _GLX_OML_sync_control; }
    bool GLX_SGIX_fbconfig() { return _GLX_SGIX_fbconfig; }
    bool GLX_SGIX_hyperpipe() { return _GLX_SGIX_hyperpipe; }
    bool GLX_SGIX_pbuffer() { return _GLX_SGIX_pbuffer; }
    bool GLX_SGIX_swap_barrier() { return _GLX_SGIX_swap_barrier; }
    bool GLX_SGIX_swap_group() { return _GLX_SGIX_swap_group; }
    bool GLX_SGIX_video_source() { return _GLX_SGIX_video_source; }
    bool GLX_SGI_cushion() { return _GLX_SGI_cushion; }
    bool GLX_SGI_swap_control() { return _GLX_SGI_swap_control; }
    bool GLX_SGI_video_sync() { return _GLX_SGI_video_sync; }
    bool GLX_SUN_get_transparent_index() { return _GLX_SUN_get_transparent_index; }
}
