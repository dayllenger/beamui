...
else
{
    bool registerFontConfigFonts(FreeTypeFontManager fontMan)
    {
        ...
        foreach (i; 0 .. fontset.nfont)
        {
            ...
            char[] face16 = family.fromStringz.dup;
            toLowerInPlace(face16);
            if (spacing == FC_MONO)
            ...
            char[] style16 = style.fromStringz.dup;
            toLowerInPlace(style16);
